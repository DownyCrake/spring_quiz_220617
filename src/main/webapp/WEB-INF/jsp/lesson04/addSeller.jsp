...
<body>
	<div class="container">
		...
		<input type="text" id="profileImageUrl" name="profileImageUrl" class="form-control col-7" placeholder="">
		</div>		
		<div class="form-group">
		<label for="temperature"><b>온도</b></label>
		<input type="text" id="temperature" name="temperature" class="form-control col-2" placeholder="">
		</div>		
